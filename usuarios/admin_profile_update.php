...
if(isset($_POST['update'])){
   ...
   $update_profile = $conn->prepare("UPDATE `usuarios` SET name = ?, email = ? WHERE id = ?");
   ...
   if(!empty($image)){
      ...
      if($image_size > 2000000){
         ...
         $update_image = $conn->prepare("UPDATE `usuarios` SET image = ? WHERE id = ?");
   ...
   if(!empty($previous_pass) || !empty($new_pass) || !empty($confirm_pass)){
      if($previous_pass != $old_pass){
         ...
         $update_password = $conn->prepare("UPDATE `usuarios` SET password = ? WHERE id = ?");
...
<head>
   ...
   <title>actualización del perfil de administrador</title>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="inputBox">
            ...
            <input type="text" name="name" required class="box" placeholder="introduzca su nombre" value="<?= $fetch_profile['name']; ?>">
            <span>email : </span>
            <input type="email" name="email" required class="box" placeholder="Introduce tu correo electrónico" value="<?= $fetch_profile['email']; ?>">
         ...
         <div class="inputBox">
            ...
            <input type="password" class="box" name="previous_pass" placeholder="ingrese la contraseña anterior" >
